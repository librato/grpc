...
extern void oboe_grpc_add_once_init(gpr_once *once);
extern void oboe_grpc_add_mutex(gpr_mu *mutex);
extern void oboe_grpc_remove_mutex(gpr_mu *mutex);
extern void oboe_grpc_add_cond(gpr_cv *cond);
extern void oboe_grpc_remove_cond(gpr_cv *cond);

void gpr_mu_init(gpr_mu* mu) {
  oboe_grpc_add_mutex(mu);
